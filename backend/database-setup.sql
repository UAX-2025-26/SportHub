...
-- Madrid
('f1111111-1111-1111-1111-111111111111', 'a1111111-1111-1111-1111-111111111111', 'Pista de Tenis 1', 'tenis', 4, 25.00, true),
('f1111111-1111-1111-1111-111111111112', 'a1111111-1111-1111-1111-111111111111', 'Pista de Tenis 2', 'tenis', 4, 25.00, true),
('f1111111-1111-1111-1111-111111111113', 'a1111111-1111-1111-1111-111111111111', 'Campo de Fútbol 7', 'futbol', 14, 60.00, true),
('f1111111-1111-1111-1111-111111111114', 'a1111111-1111-1111-1111-111111111111', 'Gimnasio Principal', 'gimnasio', 30, 15.00, true),
-- Barcelona
('f2222222-2222-2222-2222-222222222221', 'b2222222-2222-2222-2222-222222222222', 'Pista de Pádel 1', 'padel', 4, 30.00, true),
('f2222222-2222-2222-2222-222222222222', 'b2222222-2222-2222-2222-222222222222', 'Pista de Pádel 2', 'padel', 4, 30.00, true),
('f2222222-2222-2222-2222-222222222223', 'b2222222-2222-2222-2222-222222222222', 'Campo de Fútbol 11', 'futbol', 22, 80.00, true),
('f2222222-2222-2222-2222-222222222224', 'b2222222-2222-2222-2222-222222222222', 'Piscina Olímpica', 'natacion', 50, 20.00, true),
-- Valencia
('f3333333-3333-3333-3333-333333333331', 'c3333333-3333-3333-3333-333333333333', 'Pista de Baloncesto', 'baloncesto', 10, 35.00, true),
('f3333333-3333-3333-3333-333333333332', 'c3333333-3333-3333-3333-333333333333', 'Pista de Voleibol', 'voleibol', 12, 28.00, true)
ON CONFLICT (id) DO NOTHING;
