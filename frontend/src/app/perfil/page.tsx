...
import { usersService, type User, type UpdateUserData } from "@/lib/api/users.service"
        ...
        <div className={styles.perfilContainer}>
          ...
          <div className={styles.profileCard}>
            <div className={styles.profileHeader}>
              <div className={styles.avatar}>{user.nombre?.charAt(0).toUpperCase() || "U"}</div>
      ...
      <div className={clsx(bodyStyles.footer)}>
        <MainFooter>
          ...
          <div className={clsx(bodyStyles.footerButtons)}>
            ...
            <ProfileButton>
              <Imagen src={"/botones/perfil.svg"} alt={"reservas"} href={"/reservas"} />
            </ProfileButton>
          </div>
        </MainFooter>
      </div>
