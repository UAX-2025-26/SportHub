...
import { bookingsService, Booking } from "@/lib/api/bookings.service";
...
const ReservasPage: FunctionComponent = () => {
    ...
    const canCancelBooking = (booking: Booking) => {
        ...
        return estado === 'confirmada' || estado === 'confirmed' ||
               estado === 'pendiente' || estado === 'pending' || estado === 'pending_payment';
    };
                                    ...
                                    <div className={styles.bookingDetails}>
                                        ...
                                        <div className={styles.detailRow}>
                                            ...
                                            <span className={styles.detailValue}>
                                                {booking.precio_total || booking.price_paid || 0}€
                                            </span>
                                        </div>
                                        {booking.created_at && (
                                            <div className={styles.detailRow}>
